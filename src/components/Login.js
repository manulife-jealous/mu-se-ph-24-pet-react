...
const Login = ({user}) => {
    ...
    const handleOnClick = () => {
            setUser(users.filter(user => {return user.email === email && user.verify === verify}));
    ...
    <>
        ...
        <div class="_6lux">
            <div class="_6luy _55r1 _1kbt" id="passContainer">
                <input type="password" onChange={handleOnPassword} value={verify} class="inputtext _55r1 _6luy _9npi" name="pass" id="pass" data-testid="royal_pass" placeholder="Password" aria-label="Password" />
